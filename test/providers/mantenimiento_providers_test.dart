...
void main() {
  ...
  test('ordena por severidad real, no solo por la via de tiempo', () async {
    ...
    await crearRecord(ambas, ahora.subtract(const Duration(days: 100)), 496000);

    final lista = await container.read(vencimientosProvider(vehicleId).future);
  ...
  test('un vehiculo sin lecturas usa el km sembrado en sus mantenimientos como '
      'suelo, y no lo da por al dia', () async {
